...
const novoPreco = Number(prompt("insira o novo preço:"));
...
const investimento = String(prompt("Insira o tipo de investimento: "));
...
let entrada = 20;
const numPessoas = Number(prompt("numero de pessoas: "));
